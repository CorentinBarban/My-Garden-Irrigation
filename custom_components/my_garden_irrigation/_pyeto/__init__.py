"""
PyETo — vendored from https://github.com/woodcrafty/PyETo (BSD 3-Clause).

Vendored because PyETo is not published on PyPI and Home Assistant's
requirements mechanism only supports PyPI packages.
"""
from .convert import (
    celsius2kelvin,
    kelvin2celsius,
